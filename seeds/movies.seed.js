// Import mongoose and assign it to a variable
const mongoose = require("mongoose");
// Import the database connection from db/index.js
require("../db");
const Movie = require("../models/Movie.model");
// Mongoose is already imported in db/index.js which we require above
console.log("Starting to seed the database...");

// Clear existing movies before seeding
Movie.deleteMany({})
  .then(() => {
    ...
    // Seed the database with the movies
